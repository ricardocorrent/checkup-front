$(document).ready(function () {
    ...
    var urlink;
    if (type == "rules") {
        urlink = "http://localhost:8083/api/rule/"
    }
    if (type == "target") {
        urlink = "http://localhost:8083/api/target/";
    }
    $.ajax({
        url: urlink + id,
        type: 'GET',
        ...
        success: function (data) {
            ...
            if (type == "target") {
                document.getElementsByClassName("editName")[0].value = data.name;
            }
    ...
    $("#updateValues").on("click", function () {
        ...
        if (type == "target") {
            newInfo.name = document.getElementsByClassName("editName")[0].value.trim();
            start = 0;
        }

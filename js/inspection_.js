  ...
  $(document).ready(function () {
        ...
        success: function (data){
          ...
          for (var i = 0; i < leng; i++) {
            ...
            if(item.draft){
              ...
              cols += "<td><a href='inspection/inspection_information.html?id="+item.id+"&name="+item.target.name+"'><span class='fa fa-edit fa-lg'></span></a></td>";
              cols += "<td><a href='inspection/inspection_edit.html?id="+item.id+"&name="+item.target.name+"'><span class='fa fa-list-ul fa-lg'></span></a></td>";
    ...
    $("tbody").on("click", ".openInspection", function() {
      ...
      //window.open("menu.html?token="+data.token);
      window.location.replace("inspection/inspection_view.html");
    });
